...
public class AuthRedisReposotiry {
    ...
    private static final String SMS_PREFIX_COOLDOWN = "auth:sms:cooldown:";
    ...
    // 입력한 인증번호와 redis에 저장된 인증번호가 일치하는지 확인
    ...
    // 인증 완료 또는 만료 처리 시 redis의 인증번호 삭제(중복 인증 방지)
    ...
    private String generateSmsCooldown(String phoneNumber) {
        return SMS_PREFIX_COOLDOWN + phoneNumber;
    }
