from app.embedding import generate_embedding, generate_embeddings
...
def get_recommendations(payload: RecommendationRequest) -> RecommendationResponse:
    ...
    user_embedding, candidate_embeddings = enrich_embeddings(payload)
    ...
    for candidate in payload.candidates:
        candidate_embedding = candidate_embeddings.get(candidate.show_id, [])
        embedding_similarity = compute_embedding_similarity(user_embedding, candidate_embedding)
