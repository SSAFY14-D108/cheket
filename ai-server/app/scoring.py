...
from app.schemas import ArtistPreference, CandidateShow

EMBEDDING_SCORE_WEIGHT = 0.20
ARTIST_SCORE_WEIGHT = 0.45
SEARCH_BONUS_MAX = 0.10
FRESHNESS_BONUS_MAX = 0.10
TIMING_BONUS_MAX = 0.08
DIVERSITY_PENALTY_STEP = 0.00
DIVERSITY_PENALTY_CAP = 0.00
...
def compute_search_bonus(candidate: CandidateShow, recent_keywords: list[str]) -> float:
    ...
    embedding_text = normalize_text(candidate.embedding_text)
    ...
    for keyword in recent_keywords:
        ...
        if embedding_text and normalized_keyword in embedding_text:
...
def has_personalization_signal(
    ...
    return bool(user_embedding or artist_preferences or recent_keywords)
