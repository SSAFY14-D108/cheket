...
export const MOCK_EVENTS: Event[] = [
  {
    ...
    description:
      'aespa의 월드 투어 서울 공연. 대형 LED 연출과 라이브 밴드로 구성된 프리미엄 무대를 선보입니다.',
  },
  {
    id: 'evt_002',
    ...
    description:
      'METALLICA M72 월드투어 내한 공연. 원형 스테이지 기반의 몰입형 사운드를 제공합니다.',
  },
  {
    id: 'evt_003',
    name: '서울 필하모닉 신년 콘서트',
    ...
    venue: '예술의전당 콘서트홀, 서울',
    region: '서울',
    poster: 'https://picsum.photos/seed/concert3/400/600',
    status: 'SOLD_OUT',
    maxPerUser: 6,
    openDate: '2026-01-01',
    grades: [
  ...
  },
  {
    ...
    venue: '잠실종합운동장, 서울',
    region: '서울',
    poster: 'https://picsum.photos/seed/concert4/400/600',
    status: 'ON_SALE',
    maxPerUser: 4,
    openDate: '2026-06-07',
    grades: [
  ...
  },
  {
    ...
    venue: '자라섬 가평군',
    region: '경기',
    poster: 'https://picsum.photos/seed/concert5/400/600',
    status: 'ENDED',
    maxPerUser: 8,
    openDate: '2026-10-05',
    grades: [
...
export const BANNER_SLIDES: BannerSlide[] = [
  {
    id: 'b1',
    eventId: 'evt_004',
    image: 'https://picsum.photos/seed/concert4/400/600',
    title: '2026 울트라 코리아',
  ...
  },
  {
    id: 'b3',
    eventId: 'evt_002',
    image: 'https://picsum.photos/seed/concert2/400/600',
...
export const OPEN_SCHEDULE: OpenScheduleItem[] = [
  {
    id: 'op_001',
    eventId: 'evt_001',
    name: 'AESPA WORLD TOUR 2026',
...
export const MOCK_TRANSACTIONS: Transaction[] = [
  {id: 'tx_001', type: 'in', label: 'CTK 충전', date: '2025.03.01', amount: 500},
  {id: 'tx_002', type: 'out', label: '티켓 구매 - AESPA', date: '2025.02.28', amount: 140},
  {id: 'tx_003', type: 'in', label: '양도 판매 수익', date: '2025.02.25', amount: 145},
  {id: 'tx_004', type: 'out', label: '티켓 구매 - METALLICA', date: '2025.02.20', amount: 150},
  {id: 'tx_005', type: 'in', label: 'CTK 충전', date: '2025.02.15', amount: 1000},
];
...
export function generateSeats(eventId: string, gradeName?: string): Seat[] {
  ...
  const targetGrade = gradeName
    ? grades.find(g => g.name === gradeName)
    : null;
  ...
  rows.forEach((row, rowIdx) => {
    const gradeIndex = Math.min(
      Math.floor(rowIdx / gradeRowCount),
      grades.length - 1,
    );
    const grade = targetGrade ?? grades[gradeIndex];

    if (targetGrade && grades[gradeIndex].name !== targetGrade.name) {
      return;
    }
    ...
    for (let num = 1; num <= 12; num++) {
      ...
      if (targetGrade && targetGrade.remaining === 0) {
        status = 'SOLD';
      }
